...
const ANALYSIS_RULES = [
  ...
  "Choose overall_decision from: safe, borderline, high_risk, reject.",
  "Set can_enhance to true only when the review can safely proceed to enhancement without changing facts or legitimizing disallowed content.",
...
const TOOL_RULES = [
  ...
  "- If the context shows missing trust evidence, generic Gmail identity, absent LinkedIn/profile, or unclear employer/product relationship, prefer at least one tool check before returning safe.",
...
export function buildAgentTurnPrompt(input: {
  ...
  return [
    ...
    "Remaining focus: decide whether the review is safe, authentic-looking, policy-compliant, and suitable for enhancement.",
    "",
