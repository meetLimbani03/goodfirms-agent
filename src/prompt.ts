...
export const ANALYSIS_SYSTEM_PROMPT = [
  ...
  "When evidence is partial, return a flagged risk instead of a hard failure.",
...
const ANALYSIS_INSTRUCTIONS = [
  ...
  "Set can_enhance to true only when the review can safely proceed to a later enhancement step without likely changing facts or legitimizing disallowed content.",
